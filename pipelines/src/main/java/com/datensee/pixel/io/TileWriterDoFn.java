 ...
 *
 * <p>Failure handling: transcode/write exceptions emit a
 * {@link FailedTileRecord} (kind {@code UNKNOWN}, message prefixed
 * {@code write-stage:}) instead of failing the bundle — write-stage
 * partial-failure semantics mirror the fetch stage's dead-letter path.
 */
