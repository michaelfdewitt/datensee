...
/**
 * TIFF 6.0 requires out-of-line tag values to start on a word boundary
 * (even offset). The transcoder pads odd-length chunks (such as odd-byte
 * ASCII tags) to maintain word alignment for subsequent tags.
 */
class CogTranscoderAlignmentTest {
     ...
     * byte count (ImageDescription, tag 270, sorting before double-array
     * GeoTIFF tags in the output IFD) to verify alignment padding.
     */
