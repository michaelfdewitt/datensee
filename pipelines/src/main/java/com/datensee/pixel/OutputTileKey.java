...
/**
 * Composite key for the two-tier GroupByKey: which output tile a compute tile
 * belongs to.
 *
 ...
 * key-coder determinism. Java's default serialization does not guarantee
 * deterministic encoding across JVM implementations, which Dataflow requires
 * for key coders. Encoding two {@code VarInt}s guarantees deterministic
 * ordering and produces compact wire serialization.
 */
