...
public record PipelineConfig(
     ...
     * failures when writing {@code _failures.json}, ensuring the journal
     * maintains a complete view of incomplete tiles on all runners.
     */
     ...
     *
     * <p>{@code bandCount} and {@code dataType} are informational metadata
     * describing expected Earth Engine output. The transcoder determines
     * the actual sample structure directly from the TIFFs returned by Earth
     * Engine. Treat these fields as metadata for downstream consumers rather
     * than runtime validation constraints.
     */
