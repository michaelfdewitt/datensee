...
/**
 * Tests for {@link DatensEEPipeline#validateConfig} and
 * {@code pipeline_kind} discriminator handling.
 *
 * <p>Legacy flat configs (pre-discriminator {@code tile_grid}/{@code output}
 * at top level) fail with an incompatible-client message rather than
 * a raw Jackson unknown-property exception.
 */
